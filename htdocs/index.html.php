...
<article itemscope itemtype="https://schema.org/SoftwareApplication" itemid="<?= url('p:home', false) ?>">
	...
	<p itemprop="description" id="description">
		<b itemprop="name">Arx Libertatis</b> is an improved, cross-platform and open source engine for <a href="<?= url('p:wp_arx') ?>">Arx Fatalis</a>, a 2002 first-person <span itemprop="softwareApplicationSubCategory">role-playing game</span> / dungeon crawler / immersive sim developed by <a href="<?= url('p:arkane') ?>">Arkane Studios</a>.
	</p>
...
?>
		...
		<p>
			Arx Libertatis <b><?= encode_text($version) ?></b> updates and improves Arx Fatalis by supporting modern systems, porting the game to new platforms, as well as eliminating bugs and limitations. In the future we plan to improve and modernize the engine as well as enable customizations and mods by the community.
		</p>
