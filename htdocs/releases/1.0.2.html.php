...
?>
<p>
	Version 1.0.2 fixes various crashes, disappearing items when sorting the inventory, and minor rendering and input bugs. This release also fixes a bug that left the Spanish version with no text. See the <a href="<? url('changelog:1.0.2') ?>">changelog</a> for more details.
</p>
<?
 $p->details()
?>
...
<p>
	Fans of Arx Fatalis might also be interested in <a href="http://openmw.org/">OpenMW</a>, a project to create an open source and cross-platform engine for Morrowind. While they haven't yet reached a stable release, the current progress looks promising.
</p>
