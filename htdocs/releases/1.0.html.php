...
<p>
	...
	There are <a href="<? url('p:download') ?>">packages available for <? echo $p->windows_icon ?>Windows and <? echo $p->linux_icon ?>Linux</a>. On other systems you may still be able to run the game by compiling the <a href="<? url('wiki:Download#Source_Code') ?>">source code</a> yourself.
</p>
<?
 $p->details()
?>
...
?>
<p>
	<b>Update:</b> <a href="<? url('release:1.0.1') ?>">Arx Libertatis 1.0.1</a> has been released. <a href="<? url('sfdl:arx-libertatis-1.0/') ?>">Version 1.0 is archived at SourceForge.</a>
</p>
