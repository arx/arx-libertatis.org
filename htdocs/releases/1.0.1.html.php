...
<p>
	...
	This version also fixes a crash on some Linux systems and uses DirectX by default for rendering and input under Windows - see the <a href="<? url('changelog:1.0.1') ?>">changelog</a>.
</p>
<?
 $p->details()
?>
